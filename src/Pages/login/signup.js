...
const Signup = () => {
    ...
    const SignupHandler = async (e) => {
        ...
        if (!verifyName(name) || !verifyPhoneNumber(phone) || !verifyEmail(email) || !verifyPassword(password)) {
                ...
                <div className="project-login-content">
                    ...
                    <form className="login-left-section" onSubmit={SignupHandler}>
                        ...
                        <div className="login-left-content">
                            <div className="login-content-title">Sign Up</div>
                            ...
                            <div className="login-content-button">
                                <button type='submit' className="login-button content-submit-btn-disable" id='login-button'>SIGN UP</button>
                            </div>
                            <div className="login-content-signup">
                                Already have an account? <Link to={'/resturant/signin'} className='login-navigate-span' >Login</Link>
                            </div>
                        </div>
                    </form>
