...
const Login = () => {
    ...
    const LoginHandler = async (e) => {
        ...
        let response = await auth_Handler.signin({
            email, location: Location, password
        })
                    ...
                    <form className="login-left-section" onSubmit={LoginHandler}>
                        ...
                        <div className="login-left-content">
                            ...
                            <div className="login-content-forgetpass">
                                <Link to={'/resturant/forget-password'} className='login-navigate-span'>Forget Password?</Link>
                            </div>
                            <div className="login-content-button">
                                <button type='submit' className="login-button content-submit-btn-disable" id='login-button'>LOG IN</button>
                            </div>
                            <div className="login-content-signup">
                                Don't have an account? <Link to={'/resturant/signup'} className='login-navigate-span' >Sign Up</Link>
                            </div>
                        </div>
                    </form>
